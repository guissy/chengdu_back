...
// 未关联商家列表请求模式
export const shopListUnbindSchema = z.object({});
...
// 商家创建返回模式
export const shopCreateResponseSchema = z.object({
  id: z.string().describe('新建商家ID'),
});

// 通用响应模式
export const shopGenericResponseSchema = z.object({
  code: z.number(),
  data: z.any(),
});

// 类型定义
export type ShopListUnbindRequest = z.infer<typeof shopListUnbindSchema>;
export type ShopDetailRequest = z.infer<typeof shopDetailSchema>;
export type ShopAddRequest = z.infer<typeof shopAddSchema>;
export type ShopUpdateRequest = z.infer<typeof shopUpdateSchema>;
export type ShopDeleteRequest = z.infer<typeof shopDeleteSchema>;
...
export type ShopCreateResponse = z.infer<typeof shopCreateResponseSchema>;
